...
class _ShowModalSelectGoalColorState extends State<ShowModalSelectGoalColor> {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Container(
        // height: MediaQuery.of(context).size.height * 0.42, // 모달 높이 크기
                    ...
                    return GestureDetector(
                      onTap: () {
                        ...
                        Navigator.pop(context,
                            {'image': items[index], 'name': itemNames[index]});
                      },
                      child: Container(
                        decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(8),
                            color: isSelected ? Color(0xFFECECF0) : null),
                        child: Column(
                          children: [
                            SvgPicture.asset(
                              'assets/icons/gemstones/${items[index].replaceAll('.png', '.svg')}',
                              width: 24,
                              height: 24,
                            ),
                            SizedBox(
