...
import 'package:mogrow/screens/home/widget/show_modal_add_goal.dart';
...
class _ShowModalState extends State<ShowModal> {
  final List<Goal> goals = [
    Goal(goalName: '없음', goalColor: 'core'),
    Goal(goalName: '사이드 프로젝트 런칭', goalColor: 'ruby'),
    Goal(goalName: '3분기 버킷리스트', goalColor: 'sunstone'),
    Goal(goalName: '여행 계획', goalColor: 'citrine'),
  ];
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Image.asset(
                                    'assets/icons/gemstones/${goals[index].goalColor}.png'),
                              ],
                            ),
                          ),
                        ),
